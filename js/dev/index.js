import { s as slideUp, a as slideToggle, b as bodyLockToggle, c as bodyLockStatus } from "./common.min.js";
(function polyfill() {
...
window.addEventListener("load", () => {
  ...
  const headerMenuTop = document.querySelector(".header__menu .menu-top__list");
  const headerMenuLinks = headerMenu.querySelectorAll(".menu__item > a");
  const headerMenuTopLinks = headerMenuTop?.querySelectorAll("a");
  ...
  headerMenuTopLinks?.forEach((link) => {
    link.addEventListener("click", () => {
      documentBody.removeAttribute("data-fls-menu-open");
      documentBody.removeAttribute("data-fls-scrollblock");
    });
